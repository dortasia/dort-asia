...
async function downloadVisitingCardPDF(setIsDownloading?: (v: boolean) => void) {
  ...
  try {
    ...
    // Save
    pdf.save("Dinesh_DORT_Asia_Visiting_Card.pdf");
  } catch (error) {
              ...
              >
                ...
                >
                  <Image
                    ...
                    alt="Dinesh – Business Card Front"
                    fill
...
export default function DineshProfilePage() {
  ...
  return (
    <main className="min-h-screen bg-white font-text flex flex-col justify-between">
      ...
      {/* Editorial Content Section (A Note from the Founder) */}
      <section className="w-full py-16 md:py-24 px-6 md:px-10 bg-white flex justify-center font-text">
        <div className="max-w-[1200px] w-full">

          <div className="mb-10 md:mb-12">
            <span className="text-xs font-semibold text-[#86868b] uppercase tracking-wider mb-2 block">
              Perspective
            </span>
            <h2 className="text-3xl sm:text-4xl md:text-[40px] font-bold text-[#1d1d1f] tracking-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 text-[17px] md:text-[18px] text-[#1d1d1f]/80 leading-[1.75] font-normal">
            ...
            <div className="space-y-8">
              <p>
                Dinesh founded DORT Asia with a simple ambition: to build a technology company that creates practical solutions for the way businesses operate today. His experience across technology, engineering and business environments, including professional exposure in Singapore, has given him a strong understanding of how technology can be used not simply to digitize processes, but to solve real operational challenges.
              </p>

              <p>
                At DORT Asia, Dinesh is focused on building technology products and services that bring together software, digital solutions and technology talent. The company is developing its own SaaS products while also helping businesses access the technical capabilities they need to build, improve and scale their digital operations. The goal is to create solutions that are useful in the real world, commercially viable and built for long-term growth.
              </p>
            </div>
            ...
            <div className="space-y-8">
              <p>
                Dinesh sees DORT Asia as more than a technology services company. His vision is to build a technology ecosystem that can create products, develop solutions and support businesses across Singapore and Asia. The company is starting with practical problems, building with technology and growing with a long-term view.
              </p>
            </div>
