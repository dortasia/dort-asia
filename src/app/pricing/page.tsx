                ...
                >
                    ...
                    {billingInterval === 'annual' ? (
                      <div>
                        ...
                        <div className="text-xs text-blue-600 font-semibold mb-1">
                          Effective S$83.25 / month
                        </div>
                        <div className="text-xs text-[#86868b] mb-4 flex items-center gap-1.5">
                          <span>Standard: <s className="text-[#86868b]">S$1,299/yr</s></span>
                          <span className="text-emerald-600 font-semibold">• Save S$300/yr</span>
                        </div>
                      </div>
                    ) : (
                      <div>
                        ...
                        <div className="text-xs text-[#86868b] mb-4 flex items-center gap-1.5">
                          <span>Standard: <s className="text-[#86868b]">S$129/mo</s></span>
                          <span className="text-emerald-600 font-semibold">• Save S$30/mo</span>
                        </div>
                      </div>
                    )}
                  ...
                  {(!currentPlan || currentPlan === 'starter') && (
                    <button 
                      ...
                      className={`w-full mt-8 py-3.5 px-6 rounded-full text-white font-semibold text-[15px] transition-all shadow-[0_4px_16px_rgba(43,127,255,0.25)] hover:shadow-[0_6px_22px_rgba(43,127,255,0.35)] active:scale-[0.99] disabled:opacity-50 ${currentPlan === 'starter' ? 'bg-[#73a7f4] cursor-not-allowed' : 'bg-[#2b7fff] hover:bg-[#1a6eff]'}`}
                    >
                      {isLoadingPlan === 'starter' 
                        ? 'Loading...' 
                        : currentPlan === 'starter' 
                        ? 'Current Plan' 
                        : billingInterval === 'annual'
                  ...
                  <tbody>
                    <tr className="bg-white/95 border-b border-gray-200">
                      ...
                      <td className="py-4.5 px-6 text-center border-l border-gray-100">
                        {billingInterval === 'annual' ? (
                          <div>
                            <span className="text-[17px] font-bold text-[#1d1d1f]">S$999 / yr</span>
                            <span className="text-xs text-blue-600 font-semibold block">Effective S$83.25 / mo</span>
                            <span className="text-[11px] text-gray-400 block">Standard S$1,299/yr</span>
                          </div>
                        ) : (
                          <div>
                            <span className="text-[17px] font-bold text-[#1d1d1f]">S$99 / mo</span>
                            <span className="text-xs text-gray-500 block">Standard S$129/mo</span>
                          </div>
                        )}
                      </td>
