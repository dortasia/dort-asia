      ...
      >
        ...
        <div className="absolute top-[24%] md:top-[22%] lg:top-[20%] left-0 right-0 px-6 flex flex-col items-center">
          ...
          <motion.p
            ...
            className="text-[14px] md:text-[16px] text-gray-500 max-w-[720px] text-center mt-3.5 leading-relaxed font-normal"
          >
            From ready-to-use software to custom digital solutions and skilled manpower, we help businesses build, operate, and grow.
          </motion.p>
