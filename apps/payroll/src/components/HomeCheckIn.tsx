...
export default function HomeCheckIn() {
  ...
  return (
    <>
      {/* Widget */}
      <div className="bg-[#F8F9FA] dark:bg-[#1C1C22] rounded-[24px] px-6 py-5 flex items-center justify-between mt-2 mb-8 border border-transparent transition-all">
        <div>
        ...
        <div className="flex items-center gap-6">
          ...
          {clockOutTime && !clockedIn ? (
            <div className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#34C759]/15 border border-[#34C759]/30">
              ...
              <span className="text-[13px] font-bold text-[#248A3D]">Done for today</span>
            </div>
          ) : (
            <button
              onClick={() => {
              ...
              className="text-white text-[14px] font-medium transition-all hover:opacity-90 active:scale-[0.97]"
              style={{
