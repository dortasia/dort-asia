-- ============================================================
-- DORT ASIA HRMS — Complete Supabase Setup SQL
-- Paste this ENTIRE block into SQL Editor → Run
-- ============================================================
...
DROP POLICY IF EXISTS "Authenticated users can delete approvals" ON public.approvals;
CREATE POLICY "Authenticated users can delete approvals"
  ON public.approvals FOR DELETE TO authenticated USING (true);
