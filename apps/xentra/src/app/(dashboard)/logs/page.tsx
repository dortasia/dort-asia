  ...
  return (
    <div className="flex-1 flex flex-col overflow-y-auto page-scrollbar relative">
      ...
      <header className="flex items-center justify-between p-4">
        <div>
          <h1 className="text-[28px] font-medium text-[#111827] dark:text-white tracking-tight font-sans">Log Histories</h1>
      ...
      <main className="flex-1 p-4 pt-0 flex flex-col gap-5">
